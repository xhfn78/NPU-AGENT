# [실습] Dropout 적용 - 당뇨병 (회귀)
#
# 층 사이에 Dropout을 넣어서 과적합을 줄여본다.
# Dropout을 넣기 전(keras31_MCP_save_02)과 결과가 어떻게 달라지는지 비교해본다.
from sklearn.datasets import load_diabetes
from tensorflow.keras.models import Sequential
from tensorflow.keras.layers import Dense, Dropout,MaxPool2D,GlobalAveragePooling2D,Conv2D
...
#2. 모델구성
model = Sequential()
model.add(Conv2D(16,(2,1), input_shape=(10,1,1), activation='relu'))
...
loss: 6129.095703125
r2결과값: -0.04929695741299733
mse: 6129.09571505744
RMSE: 78.2885414033078
'''
