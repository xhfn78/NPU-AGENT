...
checkpoint_path = result_dir / 'keras31_MCP_save_02_diabetes.keras'
mcp = ModelCheckpoint(checkpoint_path, monitor='val_loss', save_best_only=True)
joblib.dump(scaler, result_dir / 'keras31_MCP_save_02_diabetes_scaler.joblib')
...
save_result(__file__, result_dir, config, hist, loss, y_test, y_predict,
            seconds, initial_hash, previous='keras28_Scaler02_diabetes', plot=True)
